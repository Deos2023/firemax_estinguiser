      ...
      <nav className="bg-white w-full">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="bg-red-600 px-4 py-2 -skew-x-12">
              <div className="flex items-center skew-x-12">
                <span className="text-xl font-semibold">FIREMAX SAFETY & SECURITY</span>
              </div>
            </div>
          ...
          <div className="flex items-center gap-4">
            <Link href={"tel:9051737934"} className='hidden sm:block border rounded-3xl border-neutral-500 text-sm font-semibold text-neutral-700 p-2'>
              PH : 9051737934
            </Link>
            ...
            >
              {menuOpen ? <X size={28} /> : <Menu className='text-neutral-700' size={28} />}
            </button>
          </div>
        </div>
